...
public class CustomRainbowBlock extends CustomItem {
    ...
    public CustomRainbowBlock(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, RainbowTickHandler ticker) {
    ...
    public CustomRainbowBlock(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ColoredMaterial materialType) {
        this(itemGroup, item, recipeType, recipe, new RainbowTickHandler(materialType));
    }

    public CustomRainbowBlock(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, List<Material> materials) {
