...
public final class CustomMBRecipeMachine extends CustomRecipeMachine {
    public CustomMBRecipeMachine(
            ...
            List<Integer> input,
            List<Integer> output,
            RecipeType multiBlockRecipeType,
            int energyPerCraft,
            int capacity,
                            ...
                            if (sf instanceof MultiBlockMachine mbm) {
                                ...
                                for (int i = 0; i < recipes.size(); i++) {
                                    ...
                                    if (input1 != null && output1 != null) {
                                        machineRecipes.add(new RecipeMachineRecipe(
                                                0, input1, output1, List.of(100), false, false));
                                    }
                                }
    ...
    public CustomMBRecipeMachine(
            ...
            List<Integer> input,
            List<Integer> output,
            MultiBlockMachine multiBlockMachine,
            int energyPerCraft,
            int capacity,
            @Nullable CustomMenu menu,
            int speed,
        ...
        super(
                ...
                ((Supplier<List<RecipeMachineRecipe>>) () -> {
                            ...
                            for (int i = 0; i < recipes.size(); i++) {
                                ...
                                if (input1 != null && output1 != null) {
                                    machineRecipes.add(
                                            new RecipeMachineRecipe(0, input1, output1, List.of(100), false, false));
                                }
                            }
                            return machineRecipes;
                        })
