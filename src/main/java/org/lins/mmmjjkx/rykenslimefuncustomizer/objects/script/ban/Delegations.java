...
public class Delegations {
    public static <T extends Player> T delegatePlayer(String fileName, T p) {
        return (T) Proxy.newProxyInstance(
                Player.class.getClassLoader(), new Class[] {Player.class}, new OperatorDelegation(fileName, p));
    }

    public static Server delegateServer(String fileName) {
        return (Server) Proxy.newProxyInstance(
                Server.class.getClassLoader(), new Class[] {Server.class}, new ServerDelegation(fileName));
    }
